...
public class RSAUtil {
    ...
    public static void main(String[] args) {
        Random r = new Random();
        int randomSixCode = r.nextInt(6);
        try {
            String publicKeyString = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDc+CZK9bBA9IU+gZUOc6FUGu7yO9WpTNB0PzmgFBh96Mg1WrovD1oqZ+eIF4LjvxKXGOdI79JRdve9NPhQo07+uqGQgE4imwNnRx7PFtCRryiIEcUoavuNtuRVoBAm6qdB0SrctgaqGfLgKvZHOnwTjyNqjBUxzMeQlEC2czEMSwIDAQAB";
            String data = "15600015800" + randomSixCode;
            String encrypt = RSAUtil.encryptByPubKey(data, publicKeyString);
