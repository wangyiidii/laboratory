...
import cn.yiidii.openapi.free.component.selenium.jd.JdChromeSessionManager;
import cn.yiidii.openapi.free.model.dto.jd.JdInfo;
import cn.yiidii.openapi.free.model.form.jd.JdChromeLoginForm;
import cn.yiidii.openapi.free.model.vo.JdChromeSessionVO;
...
public class JdController {
    ...
    public R<?> info() {
        ...
        Stream<JdChromeSessionVO> sorted = jdChromeSessionVOS.stream().sorted(Comparator.comparing(JdChromeSessionVO::getCreateTime));
        return R.ok(sorted);
    }
